...
{
   partial class OIC_SRZH_F : ISendRequest
   {
      ...
      private void LoadData(Job job)
      {
         ...
         ClubBs1.DataSource = iScsc.Clubs.Where(p => Fga_Uprv_U.Split(',').Contains(p.REGN_PRVN_CODE));
         DRcstBs1.DataSource = iScsc.D_RCSTs;
         //if (PrvnBs1.Count == 1) REGN_PRVN_CODELookUpEdit.EditValue = (PrvnBs1.Current as Data.Province).CODE;
