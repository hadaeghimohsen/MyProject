...
{
   partial class SoftVersionControl : ISendRequest
   {
             ...
             new List<Job>
              {
                  ...
                  new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */){Input = new List<object>{"DataGuard:SecurityPolicy:SoftVersionControl", this}},
      ...
      private void CheckSecurity(Job job)
      {
         ...
         {
            MessageBox.Show("این قسمت توسط کاربران شرکت تولید کننده قابل باز شدن می باشد لطفا با قسمت پشتیبانی 09333617031 تماس بگیرید");
      ...
      {
         DVldtBs1.DataSource = iProject.D_VLDTs;
         UserBs1.DataSource = iProject.Users;
         SubSysBs1.DataSource = iProject.Sub_Systems;
         GtwyBs1.DataSource = iProject.Gateways.Where(g => g.CONF_STAT == "002");
