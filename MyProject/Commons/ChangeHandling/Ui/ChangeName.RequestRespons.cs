...
{
   partial class ChangeName : ISendRequest
   {
      ...
      private void ProcessCmdKey(Job job)
      {
         ...
         {
            job.Next = new Job(SendType.SelfToUserInterface, "ChangeName", 04 /* Execute UnPaint */);
         }
      ...
      {
         Job _Paint = new Job(SendType.External, "ChangeName",
            new List<Job>
            {
               new Job(SendType.SelfToUserInterface, "Wall", 17 /* Execute ResetUi */),
               new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */) {  Input = new List<object> { "Commons:ChangeHandle:ChangeName", this }  },
