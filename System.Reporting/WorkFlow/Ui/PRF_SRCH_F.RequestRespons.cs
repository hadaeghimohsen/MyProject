...
namespace System.Reporting.WorkFlow.Ui
{
   partial class PRF_SRCH_F
   {
      ...
      private void ProcessCmdKey(Job job)
      {
         ...
         {
            job.Next =
               new Job(SendType.SelfToUserInterface, "PRF_SRCH_F", 06 /* Execute Close */);
         }
      ...
      private new void Paint(Job job)
      {
         Job _Paint = new Job(SendType.External, "Desktop",
            new List<Job>
            {
               ...
               new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */) {  Input = new List<object> { "Reporting:WorkFlow:PRF_SRCH_F", this }  },
      ...
      private void Close(Job job)
      {
         ...
         job.Next =
               new Job(SendType.SelfToUserInterface, "PRF_SRCH_F", 04 /* Execute UnPaint */);
      }
