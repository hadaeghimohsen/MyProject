...
{
   partial class EPIT_DFIN_F : ISendRequest
   {
               ...
               new List<Job>
               {
                  new Job(SendType.External, "Commons",
                     new List<Job>
                     {
                        ...
                        {
                           Input = new List<string> {"<Privilege>12</Privilege><Sub_Sys>10</Sub_Sys>", "DataGuard"},
      ...
      private void LoadData(Job job)
      {
         ...
         {
            firstloaded = true;
            RqtpBs.DataSource = iISP.Request_Types;
            RqttBs.DataSource = iISP.Requester_Types;
            DysnoBs.DataSource = iISP.D_YSNOs;
            DittpBs.DataSource = iISP.D_ITTPs;
         }
