namespace System.CRM.Ui.HistoryAction
{
   partial class HST_EMAL_F
   {
      ...
      private void InitializeComponent()
      {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(HST_EMAL_F));
         ...
         this.Emal_Gv = new DevExpress.XtraGrid.Views.Grid.GridView();
         ...
         ((System.ComponentModel.ISupportInitialize)(this.Emal_Gv)).BeginInit();
         ...
         this.labelControl1.Text = "تاریخچه ایمیل های ارسالی";
         // 
         // gridControl1
         // 
         this.gridControl1.DataSource = this.EmalBs;
         this.gridControl1.Dock = System.Windows.Forms.DockStyle.Fill;
         this.gridControl1.Location = new System.Drawing.Point(0, 0);
         this.gridControl1.LookAndFeel.SkinName = "Office 2013";
         this.gridControl1.LookAndFeel.UseDefaultLookAndFeel = false;
         this.gridControl1.MainView = this.Emal_Gv;
         ...
         // Emal_Gv
         // 
         this.Emal_Gv.Appearance.FocusedRow.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
         this.Emal_Gv.Appearance.FocusedRow.Options.UseBackColor = true;
         this.Emal_Gv.Appearance.GroupRow.Options.UseTextOptions = true;
         this.Emal_Gv.Appearance.GroupRow.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
         this.Emal_Gv.Appearance.HeaderPanel.Font = new System.Drawing.Font("IRANSans", 9F);
         this.Emal_Gv.Appearance.HeaderPanel.Options.UseFont = true;
         this.Emal_Gv.Appearance.HeaderPanel.Options.UseTextOptions = true;
         this.Emal_Gv.Appearance.HeaderPanel.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
         this.Emal_Gv.Appearance.Row.Font = new System.Drawing.Font("IRANSans", 9F);
         this.Emal_Gv.Appearance.Row.Options.UseFont = true;
         this.Emal_Gv.Appearance.Row.Options.UseTextOptions = true;
         this.Emal_Gv.Appearance.Row.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
         this.Emal_Gv.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            ...
            this.gridColumn1,
            this.gridColumn2});
         this.Emal_Gv.GridControl = this.gridControl1;
         this.Emal_Gv.GroupCount = 1;
         this.Emal_Gv.Name = "Emal_Gv";
         this.Emal_Gv.OptionsBehavior.AutoExpandAllGroups = true;
         this.Emal_Gv.OptionsBehavior.Editable = false;
         this.Emal_Gv.OptionsBehavior.ReadOnly = true;
         this.Emal_Gv.OptionsFind.AlwaysVisible = true;
         this.Emal_Gv.OptionsFind.FindDelay = 100;
         this.Emal_Gv.OptionsSelection.EnableAppearanceFocusedCell = false;
         this.Emal_Gv.OptionsView.EnableAppearanceEvenRow = true;
         this.Emal_Gv.OptionsView.ShowDetailButtons = false;
         this.Emal_Gv.OptionsView.ShowIndicator = false;
         this.Emal_Gv.SortInfo.AddRange(new DevExpress.XtraGrid.Columns.GridColumnSortInfo[] {
            new DevExpress.XtraGrid.Columns.GridColumnSortInfo(this.gridColumn2, DevExpress.Data.ColumnSortOrder.Ascending)});
         this.Emal_Gv.CustomUnboundColumnData += new DevExpress.XtraGrid.Views.Base.CustomColumnDataEventHandler(this.Logc_Gv_CustomUnboundColumnData);
         this.Emal_Gv.DoubleClick += new System.EventHandler(this.Emal_Gv_DoubleClick);
         // 
         // colRQRO_RQST_RQID
         // 
         ...
         // colSUBJ_DESC
         // 
         this.colSUBJ_DESC.Caption = "موضوع ایمیل";
         ...
         this.TodayRqst_Cb.Location = new System.Drawing.Point(438, 72);
         this.TodayRqst_Cb.Name = "TodayRqst_Cb";
         this.TodayRqst_Cb.Size = new System.Drawing.Size(105, 26);
         this.TodayRqst_Cb.TabIndex = 0;
         this.TodayRqst_Cb.Tag = "005";
         this.TodayRqst_Cb.Text = "ایمیل های امروز";
         ...
         this.YesterdayRqst_Cb.Location = new System.Drawing.Point(268, 40);
         this.YesterdayRqst_Cb.Name = "YesterdayRqst_Cb";
         this.YesterdayRqst_Cb.Size = new System.Drawing.Size(106, 26);
         this.YesterdayRqst_Cb.TabIndex = 0;
         this.YesterdayRqst_Cb.Tag = "004";
         this.YesterdayRqst_Cb.Text = "ایمیل های دیروز";
         ...
         this.AllRqst_Cb.Location = new System.Drawing.Point(451, 8);
         this.AllRqst_Cb.Name = "AllRqst_Cb";
         this.AllRqst_Cb.Size = new System.Drawing.Size(92, 26);
         this.AllRqst_Cb.TabIndex = 0;
         this.AllRqst_Cb.TabStop = true;
         this.AllRqst_Cb.Tag = "001";
         this.AllRqst_Cb.Text = "کلیه ایمیل ها";
         ...
         this.MonthRqst_Cb.Location = new System.Drawing.Point(237, 8);
         this.MonthRqst_Cb.Name = "MonthRqst_Cb";
         this.MonthRqst_Cb.Size = new System.Drawing.Size(137, 26);
         this.MonthRqst_Cb.TabIndex = 0;
         this.MonthRqst_Cb.Tag = "002";
         this.MonthRqst_Cb.Text = "ایمیل های یکماه پیش";
         ...
         this.WeekRqst_Cb.Location = new System.Drawing.Point(408, 40);
         this.WeekRqst_Cb.Name = "WeekRqst_Cb";
         this.WeekRqst_Cb.Size = new System.Drawing.Size(135, 26);
         this.WeekRqst_Cb.TabIndex = 0;
         this.WeekRqst_Cb.Tag = "003";
         this.WeekRqst_Cb.Text = "ایمیل های هفته پیش";
         ...
         // Comment_Txt
         // 
         this.Comment_Txt.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.EmalBs, "EMAL_CMNT", true));
         ...
         ((System.ComponentModel.ISupportInitialize)(this.Emal_Gv)).EndInit();
      ...
      private DevExpress.XtraGrid.Views.Grid.GridView Emal_Gv;
