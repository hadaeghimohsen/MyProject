...
{
   partial class REGN_DFIN_F : ISendRequest
   {
               ...
               new List<Job>
               {
                  new Job(SendType.External, "Commons",
                     new List<Job>
                     {
                        ...
                        {
                           Input = new List<string> {"<Privilege>2</Privilege><Sub_Sys>11</Sub_Sys>", "DataGuard"},
                           AfterChangedOutput = new Action<object>((output) => {
                              if ((bool)output)
                                 return;
                              #region Show Error
                              job.Status = StatusType.Failed;
                              MessageBox.Show(this, "خطا - عدم دسترسی به ردیف 2 امنیتی", "خطا دسترسی");
                              #endregion                           
                           })
                        },
                        #endregion                        
      ...
      {
         DcntpBs1.DataSource = iCRM.D_CNTPs;
         DwkdyBs1.DataSource = iCRM.D_WKDies;
         DactvBs1.DataSource = iCRM.D_ACTVs;
         IscgBs1.DataSource = iCRM.Isic_Groups;
         Iscg2Bs1.DataSource = iCRM.Isic_Groups;
