...
{
   partial class SecurityManagment : ISendRequest
   {
             ...
             new List<Job>
              {
                  ...
                  new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */){Input = new List<object>{"DataGuard:SecurityPolicy:SecurityManagment", this}},
      ...
      {
         DYsnoBs1.DataSource = iProject.D_YSNOs;
         DVldtBs.DataSource = iProject.D_VLDTs;
