...
namespace System.ServiceDefinition.GrpHdr.Ui
{
   partial class Create : ISendRequest
   {
      ...
      {
         Enabled = true;
         te_titleen.Text = te_titlefa.Text = "";
         job.Status = StatusType.Successful;
      }
             ...
             new List<Job>
              {
                  ...
                  new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */){Input = new List<object>{"ServiceDefinition:GroupHeader:Create", this}},
      ...
      {
         job.Next =
            new Job(SendType.SelfToUserInterface, "Create", 08 /* LoadRolesOfUser */);
         job.Status = StatusType.Successful;
      }
