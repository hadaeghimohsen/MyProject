...
{
   public partial class INF_CASE_F : UserControl
   {
      public INF_CASE_F()
      {
         InitializeComponent();
      ...
      private void RqstBs_CurrentChanged(object sender, EventArgs e)
      {
         try
         {
            SubmitChange_Butn.Enabled = SubmitChangeClose_Butn.Enabled = RqstCncl_Butn.Enabled = CreateChild_Butn.Enabled = ResolveCase_Butn.Enabled = RqstAdd_Butn.Enabled = true;
            ...
            {
               SubmitChange_Butn.Enabled = SubmitChangeClose_Butn.Enabled = RqstCncl_Butn.Enabled = CreateChild_Butn.Enabled = ResolveCase_Butn.Enabled = RqstAdd_Butn.Enabled = false;
            }
