...
{
   partial class SettingsPrivacy : ISendRequest
   {
               ...
               new List<Job>
               {
                  new Job(SendType.External, "Commons",
                     new List<Job>
                     {
                        ...
                        {
                           Input = new List<string> {"<Privilege>36</Privilege><Sub_Sys>0</Sub_Sys>", "DataGuard"},
      ...
      {
         RegnBs.DataSource = iProject.Regions;
         job.Status = StatusType.Successful;
      }
      ...
      {
         SwitchButtonsTabPage(Region_Butn);
         job.Status = StatusType.Successful;
      }
   }
}
