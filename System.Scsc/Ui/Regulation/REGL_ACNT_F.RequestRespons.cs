...
{
   partial class REGL_ACNT_F : ISendRequest
   {
      ...
      private void ProcessCmdKey(Job job)
      {
         ...
         {
            job.Next =
               new Job(SendType.SelfToUserInterface, "REGL_ACNT_F", 04 /* Execute UnPaint */);
         }
      ...
      private void LoadData(Job job)
      {
         ...
         regulationBindingSource.DataSource = iScsc.Regulations.Where(r => r == Current);
         expense_CashBindingSource.DataSource = iScsc.Expense_Cashes.Where(e => e.REGL_YEAR == Current.YEAR && e.REGL_CODE == Current.CODE);
