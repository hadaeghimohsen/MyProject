...
{
   partial class BANK_DVLP_F : ISendRequest
   {
      ...
      private void LoadData(Job job)
      {
         ...
         DatypBs.DataSource = iRoboTech.D_ATYPs;
         DordtBs.DataSource = iRoboTech.D_ORDTs.Where(o => o.VALU == "004" || o.VALU == "013" || o.VALU == "015" || o.VALU == "024");
         job.Status = StatusType.Successful;
      }
