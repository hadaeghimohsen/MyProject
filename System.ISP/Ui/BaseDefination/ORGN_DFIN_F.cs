   ...
   public partial class ORGN_DFIN_F : UserControl
   {
      ...
      private void TransferOrgnDcmt_Butn_Click(object sender, EventArgs e)
      {
         try
         {
            ...
            foreach (var rqdc in rqrq.Request_Documents)
            {
               ...
               {
                  iISP.INS_OGDC_P(sunt.BUNT_DEPT_ORGN_CODE, sunt.BUNT_DEPT_CODE, sunt.BUNT_CODE, sunt.CODE, rqdc.RDID, rqdc.NEED_TYPE, "002");
               }
            }
            requery = true;
         }
      ...
      private void RqrqBs_CurrentChanged(object sender, EventArgs e)
      {
         try
         {
            ...
            BcdsBs.DataSource = iISP.Basic_Calculate_Discounts.Where(b => b.Sub_Unit == sunt);
            OgdcBs.DataSource = iISP.Organ_Documents.Where(o => o.Sub_Unit == sunt && o.Request_Document.Request_Requester == rqrq);
         }
         catch (Exception exc)
         {
            MessageBox.Show(exc.Message);
      ...
      private void OrgnBs_CurrentChanged(object sender, EventArgs e)
      {
         ...
         DeptBs.DataSource = iISP.Departments.Where(d => d.Organ == orgn);
      }
      ...
      private void DeptBs_CurrentChanged(object sender, EventArgs e)
      {
         ...
         BuntBs.DataSource = iISP.Base_Units.Where(d => d.Department == dept);
      }
      ...
      private void BuntBs_CurrentChanged(object sender, EventArgs e)
      {
         ...
         SuntBs.DataSource = iISP.Sub_Units.Where(d => d.Base_Unit == bunt);
      }
   }
}
