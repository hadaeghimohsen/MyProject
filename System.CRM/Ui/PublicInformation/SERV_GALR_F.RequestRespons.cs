...
{
   partial class SERV_GALR_F : ISendRequest
   {
      public IRouter _DefaultGateway { get; set; }
      private Data.iCRMDataContext iProject;
      private string ConnectionString;
      private string CurrentUser;
      private Data.Service serv;
      ...
      private void Set(Job job)
      {
         ...
         iProject = new Data.iCRMDataContext(GetConnectionString.Output.ToString());
      ...
      {
         serv = job.Input as Data.Service;
         Execute_Query();
         job.Status = StatusType.Successful;
      }
   }
