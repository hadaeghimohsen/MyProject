...
{
   partial class StartDrawer : ISendRequest
   {
      ...
      private void ProcessCmdKey(Job job)
      {
         ...
         {
            job.Next =
               new Job(SendType.SelfToUserInterface, "StartDrawer", 06 /* Execute CloseDrawer */)
               {
                  Next = new Job(SendType.SelfToUserInterface, "StartDrawer", 04 /* Execute UnPaint */)
               };
         }
      ...
      private new void Paint(Job job)
      {
         Job _Paint = new Job(SendType.External, "Desktop",
            new List<Job>
            {
               ...
               new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */) {  Input = new List<object> { "Commons:Desktop:StartDrawer", this }  },
      ...
      {
         toggleMode = (bool)job.Input;

         int distance = toggleMode ? 16 : 26;
         ...
         switch (detailShow)
         {
            ...
            case DetailShow.Minimum:
               for (int i = 0; i <= Width - distance; i += Step)
               {
