namespace System.Scsc.Ui.Reason
{
   partial class CMN_RESN_F
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.RqroRwno_Lb = new System.Windows.Forms.Label();
         ...
         this.ResnRwno_Clm = new DevExpress.XtraGrid.Columns.GridColumn();
         ...
         this.OthrDesc_Clm = new DevExpress.XtraGrid.Columns.GridColumn();
         ...
         this.Rqid_Lb.Location = new System.Drawing.Point(755, 16);
         this.Rqid_Lb.Name = "Rqid_Lb";
         this.Rqid_Lb.Size = new System.Drawing.Size(85, 13);
         this.Rqid_Lb.TabIndex = 1;
         ...
         this.RqtpDesc_Lb.Location = new System.Drawing.Point(626, 16);
         this.RqtpDesc_Lb.Name = "RqtpDesc_Lb";
         this.RqtpDesc_Lb.Size = new System.Drawing.Size(49, 13);
         this.RqtpDesc_Lb.TabIndex = 1;
         this.RqtpDesc_Lb.Text = "نوع تقاضا";
         // 
         // FileNo_Lb
         // 
         ...
         this.FileNo_Lb.Location = new System.Drawing.Point(386, 16);
         this.FileNo_Lb.Name = "FileNo_Lb";
         this.FileNo_Lb.Size = new System.Drawing.Size(67, 13);
         this.FileNo_Lb.TabIndex = 1;
         this.FileNo_Lb.Text = "شماره پرونده";
         // 
         // RqroRwno_Lb
         // 
         this.RqroRwno_Lb.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
         this.RqroRwno_Lb.AutoSize = true;
         this.RqroRwno_Lb.Location = new System.Drawing.Point(478, 16);
         this.RqroRwno_Lb.Name = "RqroRwno_Lb";
         this.RqroRwno_Lb.Size = new System.Drawing.Size(77, 13);
         this.RqroRwno_Lb.TabIndex = 1;
         this.RqroRwno_Lb.Text = "ردیف درخواست";
         // 
         // RsrqGv1
         // 
         this.RsrqGv1.DataSource = this.RsrqBs1;
         this.RsrqGv1.Dock = System.Windows.Forms.DockStyle.Fill;
         ...
         this.RsrqGv1.Location = new System.Drawing.Point(0, 111);
         ...
         this.RsrqGv1.Size = new System.Drawing.Size(862, 425);
         ...
         // ResnRwno_Clm
         // 
         this.ResnRwno_Clm.Caption = "نوع دلیل";
         this.ResnRwno_Clm.ColumnEdit = this.repositoryItemLookUpEdit1;
         this.ResnRwno_Clm.FieldName = "RESN_RWNO";
         this.ResnRwno_Clm.Fixed = DevExpress.XtraGrid.Columns.FixedStyle.Right;
         this.ResnRwno_Clm.Name = "ResnRwno_Clm";
         this.ResnRwno_Clm.Visible = true;
         this.ResnRwno_Clm.VisibleIndex = 1;
         this.ResnRwno_Clm.Width = 224;
         // 
         ...
         this.Rwno_Clm.Width = 48;
         // 
         // OthrDesc_Clm
         // 
         this.OthrDesc_Clm.Caption = "توضیحات";
         this.OthrDesc_Clm.FieldName = "OTHR_DESC";
         this.OthrDesc_Clm.Name = "OthrDesc_Clm";
         this.OthrDesc_Clm.Visible = true;
         this.OthrDesc_Clm.VisibleIndex = 0;
         this.OthrDesc_Clm.Width = 525;
         // 
         // colCRET_BY
         // 
         ...
         // groupBox1
         // 
         this.groupBox1.Controls.Add(this.RqroRwno_Lb);
         this.groupBox1.Controls.Add(this.FileNo_Lb);
         this.groupBox1.Controls.Add(this.rWNOTextEdit);
         this.groupBox1.Controls.Add(this.RqtpDesc_Lb);
         this.groupBox1.Controls.Add(this.fILE_NOTextEdit);
         this.groupBox1.Controls.Add(this.Rqid_Lb);
         ...
         this.groupBox1.Size = new System.Drawing.Size(862, 64);
         ...
         this.rWNOTextEdit.Location = new System.Drawing.Point(478, 33);
         ...
         this.fILE_NOTextEdit.Location = new System.Drawing.Point(372, 32);
         ...
         this.rQTP_DESCTextEdit.Location = new System.Drawing.Point(560, 32);
         ...
         this.rQIDTextEdit.Location = new System.Drawing.Point(747, 32);
         ...
         this.RqstBn1.Size = new System.Drawing.Size(862, 47);
         ...
         this.Controls.Add(this.RsrqGv1);
      ...
      private DevExpress.XtraGrid.Columns.GridColumn ResnRwno_Clm;
      ...
      private DevExpress.XtraGrid.Columns.GridColumn OthrDesc_Clm;
      ...
      private Windows.Forms.Label RqroRwno_Lb;
   }
}
