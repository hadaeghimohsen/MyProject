...
{
   partial class MSTR_REGN_F : ISendRequest
   {
      ...
      private void ProcessCmdKey(Job job)
      {
         ...
         {
            job.Next =
               new Job(SendType.SelfToUserInterface, "MSTR_REGN_F", 04 /* Execute UnPaint */);
         }
      ...
      private new void Paint(Job job)
      {
         ...
         //      new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */) {  Input = new List<object> { "Scsc:MSTR_REGN_F", this }  },
