...
{
   partial class COMP_CHNG_F : ISendRequest
   {
      ...
      private void LoadData(Job job)
      {
         ...
         IscgBs.DataSource = iCRM.Isic_Groups;
         job.Status = StatusType.Successful;
      }
      ...
      private void Actn_CalF_P(Job job)
      {
         ...
         if(xinput != null)
         {
            ...
            if(formtype == "edit")
            {
               Comp_Pn.Visible = true;
               FormHeader_Lb.Text = "ویرایش کردن";
               Comp_Lov.Enabled = false;
            }
            else if(formtype == "add")
            {
               Comp_Pn.Visible = false;
               FormHeader_Lb.Text = "اضافه کردن";
            }
            Execute_Query();
            Comp_Lov.EditValue = code;
         }
      ...
      private void CordinateGetSet(Job job)
      {
         ...
         if (xinput != null)
         {
            if(xinput.Attribute("outputtype").Value == "billaddress")
            {
               BillXCord_Txt.Text = xinput.Attribute("cordx").Value;
               BillYCord_Txt.Text = xinput.Attribute("cordy").Value;
               BillAddrZoom_Txt.Text = xinput.Attribute("zoom").Value;
            }
            else if(xinput.Attribute("outputtype").Value == "shippingaddress")
            {
               ShipXCord_Txt.Text = xinput.Attribute("cordx").Value;
