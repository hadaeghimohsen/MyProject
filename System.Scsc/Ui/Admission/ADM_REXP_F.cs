...
{
   public partial class ADM_REXP_F : UserControl
   {
      public ADM_REXP_F()
      {
         InitializeComponent();
         ...
         XElement x =
            new XElement(
               ...
               new XElement("Request",
                  ...
                  new XAttribute("msttcode", SSTT_MSTT_CODE_TextBox.Text),
                  new XAttribute("ssttcode", SSTT_CODE_TextBox.Text)
               ),
               new XElement("Form",
                  new XAttribute("mtodnumb", 18)
               )
            );
