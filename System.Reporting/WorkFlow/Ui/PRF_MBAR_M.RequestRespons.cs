...
{
   partial class PRF_MBAR_M : ISendRequest
   {
      ...
      private void ProcessCmdKey(Job job)
      {
         ...
         {
            job.Next =
               new Job(SendType.SelfToUserInterface, "PRF_MBAR_M", 06 /* Execute Close */);
         }
      ...
      private new void Paint(Job job)
      {
         ...
         Job _Paint = new Job(SendType.External, "Desktop",
            new List<Job>
            {
               ...
               new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */) {  Input = new List<object> { "Reporting:WorkFlow:PRF_MBAR_M", this }  },
      ...
      private void Close(Job job)
      {
         ...
         job.Next =
               new Job(SendType.SelfToUserInterface, "PRF_MBAR_M", 04 /* Execute UnPaint */);

         
         _DefaultGateway.Gateway(
            new Job(SendType.External, "Localhost", "PRF_SPRF_F", 13 /* Execute SetItemCheckMode */, SendType.SelfToUserInterface));
