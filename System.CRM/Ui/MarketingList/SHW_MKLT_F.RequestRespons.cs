...
{
   partial class SHW_MKLT_F : ISendRequest
   {
      ...
      private void LoadData(Job job)
      {
         ...
         {
            Invoke(new Action(() => {
               DsrstBs.DataSource = iCRM.D_SRSTs;
      ...
      private void GetNewRecord(Job job)
      {
         ...
         var newmklt = MkltBs.Current as Data.Marketing_List;
         ...
         if (xinput != null)
         {
            switch (xinput.Attribute("moveposition").Value)
            {
               case "next":
                  MkltBs.MoveNext();
                  newmklt = MkltBs.Current as Data.Marketing_List;
