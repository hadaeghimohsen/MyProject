...
{
   partial class INF_CUST_F : ISendRequest
   {
      ...
      private bool reloading = false, requery = false;
      ...
      private void LoadData(Job job)
      {
         if(!isFirstLoaded)
         {
            ...
            DsftpBs1.DataSource = iCRM.D_SFTPs;
            DcntpBs1.DataSource = iCRM.D_CNTPs;
            JobpBs3.DataSource = iCRM.Job_Personnels;
            isFirstLoaded = true;
         }
      ...
      {
         var inputx = job.Input as XElement;
         fileno = Convert.ToInt64(inputx.Attribute("fileno").Value);
         Execute_Query();
         job.Status = StatusType.Successful;
      }
