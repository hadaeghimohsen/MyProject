...
{
   partial class RBSM_DVLP_F : ISendRequest
   {
      ...
      private void ProcessCmdKey(Job job)
      {
         ...
         {
            ClearParm_Butn_Click(null, null);
         }
               ...
               new List<Job>
               {
                  new Job(SendType.External, "Commons",
                     new List<Job>
                     {
                        ...
                        {
                           Input = new List<string> {"<Privilege>78</Privilege><Sub_Sys>12</Sub_Sys>", "DataGuard"},
      ...
      {
         DcntpBs.DataSource = iRoboTech.D_CNTPs;         
         DelmtBs.DataSource = iRoboTech.D_ELMTs;
         DgmtpBs.DataSource = iRoboTech.D_GMTPs;
         Execute_Query();
         job.Status = StatusType.Successful;
      }
