namespace System.CRM.Ui.Contract
{
   partial class SHW_CLIN_F
   {
      ...
      private void InitializeComponent()
      {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SHW_CLIN_F));
         ...
         this.Contract1_Lbl = new C1.Win.C1Ribbon.RibbonLabel();
         this.ribbonSeparator1 = new C1.Win.C1Ribbon.RibbonSeparator();
         this.Contract1_Btn = new C1.Win.C1Ribbon.RibbonButton();
         this.Contract2_Btn = new C1.Win.C1Ribbon.RibbonButton();
         this.Contract3_Btn = new C1.Win.C1Ribbon.RibbonButton();
         this.Contract4_Btn = new C1.Win.C1Ribbon.RibbonButton();
         this.Contract5_Btn = new C1.Win.C1Ribbon.RibbonButton();
         this.Contract6_Btn = new C1.Win.C1Ribbon.RibbonButton();
         ...
         // ClinBs
         // 
         this.ClinBs.DataSource = typeof(System.CRM.Data.Contract_Line);
         // 
         // Menu_Rbn
         // 
         ...
         this.ribbonTab1.Text = "مفاد قرارداد";
         // 
         // ribbonGroup11
         // 
         ...
         // ribbonMenu1
         // 
         this.ribbonMenu1.Items.Add(this.Contract1_Lbl);
         this.ribbonMenu1.Items.Add(this.ribbonSeparator1);
         this.ribbonMenu1.Items.Add(this.Contract1_Btn);
         this.ribbonMenu1.Items.Add(this.Contract2_Btn);
         this.ribbonMenu1.Items.Add(this.Contract3_Btn);
         this.ribbonMenu1.Items.Add(this.Contract4_Btn);
         this.ribbonMenu1.Items.Add(this.Contract5_Btn);
         this.ribbonMenu1.Items.Add(this.Contract6_Btn);
         ...
         // Contract1_Lbl
         // 
         this.Contract1_Lbl.Name = "Contract1_Lbl";
         this.Contract1_Lbl.Text = "نمایش های سیستم";
         // 
         // ribbonSeparator1
         // 
         ...
         // Contract1_Btn
         // 
         this.Contract1_Btn.Name = "Contract1_Btn";
         this.Contract1_Btn.Tag = "1";
         this.Contract1_Btn.Text = "ارتباطات با من";
         this.Contract1_Btn.Click += new System.EventHandler(this.ContractShows_Btn_Click);
         // 
         // Contract2_Btn
         // 
         this.Contract2_Btn.Name = "Contract2_Btn";
         this.Contract2_Btn.Tag = "2";
         this.Contract2_Btn.Text = "تمامی قراردادها";
         this.Contract2_Btn.Click += new System.EventHandler(this.ContractShows_Btn_Click);
         // 
         // Contract3_Btn
         // 
         this.Contract3_Btn.Name = "Contract3_Btn";
         this.Contract3_Btn.Tag = "3";
         this.Contract3_Btn.Text = "قراردادهای لغو شده";
         this.Contract3_Btn.Click += new System.EventHandler(this.ContractShows_Btn_Click);
         // 
         // Contract4_Btn
         // 
         this.Contract4_Btn.Name = "Contract4_Btn";
         this.Contract4_Btn.Tag = "4";
         this.Contract4_Btn.Text = "قراردادهای من";
         this.Contract4_Btn.Click += new System.EventHandler(this.ContractShows_Btn_Click);
         // 
         // Contract5_Btn
         // 
         this.Contract5_Btn.Name = "Contract5_Btn";
         this.Contract5_Btn.Tag = "5";
         this.Contract5_Btn.Text = "قراردادهای منقضی شده";
         this.Contract5_Btn.Click += new System.EventHandler(this.ContractShows_Btn_Click);
         // 
         // Contract6_Btn
         // 
         this.Contract6_Btn.Name = "Contract6_Btn";
         this.Contract6_Btn.Tag = "6";
         this.Contract6_Btn.Text = "قراردادهای موقتا متوقف شده";
         this.Contract6_Btn.Click += new System.EventHandler(this.ContractShows_Btn_Click);
         // 
         // ribbonGroup2
         // 
         ...
         // Lead_Gc
         // 
         this.Lead_Gc.DataSource = this.ClinBs;
         ...
         this.colTITL.VisibleIndex = 2;
         this.colTITL.Width = 634;
         // 
         // colNET_AMNT_DNRM
         // 
         this.colNET_AMNT_DNRM.Caption = "خالص";
         this.colNET_AMNT_DNRM.FieldName = "NET_AMNT_DNRM";
         this.colNET_AMNT_DNRM.Name = "colNET_AMNT_DNRM";
         this.colNET_AMNT_DNRM.Visible = true;
         this.colNET_AMNT_DNRM.VisibleIndex = 0;
         this.colNET_AMNT_DNRM.Width = 169;
         // 
         // colALOT_REMN
         // 
      ...
      private C1.Win.C1Ribbon.RibbonButton Contract1_Btn;
      private C1.Win.C1Ribbon.RibbonButton Contract2_Btn;
      private C1.Win.C1Ribbon.RibbonButton Contract3_Btn;
      private C1.Win.C1Ribbon.RibbonButton Contract4_Btn;
      private C1.Win.C1Ribbon.RibbonButton Contract5_Btn;
      private C1.Win.C1Ribbon.RibbonButton Contract6_Btn;
      private C1.Win.C1Ribbon.RibbonLabel Contract1_Lbl;
      ...
      private DevExpress.XtraGrid.Columns.GridColumn colNET_AMNT_DNRM;
