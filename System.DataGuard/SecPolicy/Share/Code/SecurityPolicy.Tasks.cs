...
namespace System.DataGuard.SecPolicy.Share.Code
{
   partial class SecurityPolicy
   {
      ...
      private void GetUi(Job job)
      {
         ...
         else if (value == "settingsregion")
         {
            if (_SettingsRegion == null)
               _SettingsRegion = new Ui.SettingsRegion { _DefaultGateway = this };
            job.Output = _SettingsRegion;
         }
         else if (value == "settingssystemlicense")
         {
            if (_SettingsSystemLicense == null)
         ...
         else if (value == "settingssystemtinylock")
         {
            if (_SettingsSystemTinyLock == null)
      ...
      /// </summary>
      /// <param name="job"></param>
      private void DoWork4SettingsRegion(Job job)
      {
         if (job.Status == StatusType.Running)
         {
            job.Status = StatusType.WaitForPreconditions;
            job.OwnerDefineWorkWith.AddRange(
               new List<Job>
               {
                  new Job(SendType.Self, 01 /* Execute GetUi*/){Input = "settingsregion"},
                  new Job(SendType.SelfToUserInterface, "SettingsRegion", 02 /* Execute Set */),                  
                  //new Job(SendType.SelfToUserInterface, "SettingsSystemPackage", 05 /* Execute CheckSecurity */),
                  new Job(SendType.SelfToUserInterface, "SettingsRegion", 07 /* Execute LoadData */),
                  new Job(SendType.SelfToUserInterface, "SettingsRegion", 03 /* Execute Paint */)
               });
         }
         else if (job.Status == StatusType.SignalForPreconditions)
         {
      ...
      /// </summary>
      /// <param name="job"></param>
      private void DoWork4SettingsSystemLicense(Job job)
      {
         if (job.Status == StatusType.Running)
         {
            job.Status = StatusType.WaitForPreconditions;
            job.OwnerDefineWorkWith.AddRange(
               new List<Job>
               {
                  new Job(SendType.Self, 01 /* Execute GetUi*/){Input = "settingssystemlicense"},
                  new Job(SendType.SelfToUserInterface, "SettingsSystemLicense", 02 /* Execute Set */),                  
                  //new Job(SendType.SelfToUserInterface, "SettingsSystemPackage", 05 /* Execute CheckSecurity */),
      ...
      /// </summary>
      /// <param name="job"></param>
      private void DoWork4SettingsSystemTinyLock(Job job)
      {
         if (job.Status == StatusType.Running)
         {
            job.Status = StatusType.WaitForPreconditions;
            job.OwnerDefineWorkWith.AddRange(
               new List<Job>
               {
                  new Job(SendType.Self, 01 /* Execute GetUi*/){Input = "settingssystemtinylock"},
                  new Job(SendType.SelfToUserInterface, "SettingsSystemTinyLock", 02 /* Execute Set */),                  
                  //new Job(SendType.SelfToUserInterface, "SettingsSystemPackage", 05 /* Execute CheckSecurity */),
