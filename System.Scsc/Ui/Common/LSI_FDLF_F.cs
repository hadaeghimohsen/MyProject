...
namespace System.Scsc.Ui.Common
{
   public partial class LSI_FDLF_F : UserControl
   {
      ...
      private void colActn_Butn_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
      {
         ...
         switch (e.Button.Index)
         {
            ...
            case 1:
               ...
               break;
            case 2:
               if (MessageBox.Show(this, "آیا با بازیابی مشتری موافق هستید؟", "عملیات بازیابی مشتری", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) != DialogResult.Yes) return;
      ...
      private void Search_Butn_Click(object sender, EventArgs e)
      {
         try
         {
            vF_Last_Info_FighterResultBindingSource.DataSource = iScsc.VF_Last_Info_Deleted_Fighter(null, FrstName_Txt.Text, LastName_Txt.Text, NatlCode_Txt.Text, FngrPrnt_Txt.Text, CellPhon_Txt.Text, TellPhon_Txt.Text, (Men_Rb.Checked ? "001" : Women_Rb.Checked ? "002" : null), ServNo_Txt.Text, GlobCode_Txt.Text, null, null, null, null);
