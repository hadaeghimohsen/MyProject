namespace System.CRM.Ui.HistoryAction
{
   partial class HST_MESG_F
   {
      ...
      private void InitializeComponent()
      {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(HST_MESG_F));
         ...
         this.Mesg_Gv = new DevExpress.XtraGrid.Views.Grid.GridView();
         ...
         this.colSPRB_RWNO_DNRM = new DevExpress.XtraGrid.Columns.GridColumn();
         ...
         this.colMSID = new DevExpress.XtraGrid.Columns.GridColumn();
         this.colMESG_DATE = new DevExpress.XtraGrid.Columns.GridColumn();
         this.colMESG_CMNT = new DevExpress.XtraGrid.Columns.GridColumn();
         this.colCELL_PHON = new DevExpress.XtraGrid.Columns.GridColumn();
         this.colMESG_TYPE = new DevExpress.XtraGrid.Columns.GridColumn();
         this.colMESG_STAT = new DevExpress.XtraGrid.Columns.GridColumn();
         ...
         this.labelControl1.Text = "تاریخچه پیامک ها";
         // 
         // gridControl1
         // 
         this.gridControl1.DataSource = this.MesgBs;
         this.gridControl1.Dock = System.Windows.Forms.DockStyle.Fill;
         this.gridControl1.Location = new System.Drawing.Point(0, 0);
         this.gridControl1.LookAndFeel.SkinName = "Office 2013";
         this.gridControl1.LookAndFeel.UseDefaultLookAndFeel = false;
         this.gridControl1.MainView = this.Mesg_Gv;
         ...
         this.Mesg_Gv.Appearance.GroupRow.Options.UseTextOptions = true;
         this.Mesg_Gv.Appearance.GroupRow.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
         this.Mesg_Gv.Appearance.HeaderPanel.Font = new System.Drawing.Font("IRANSans", 9F);
         ...
         this.Mesg_Gv.Appearance.Row.Font = new System.Drawing.Font("IRANSans", 9F);
         ...
         this.Mesg_Gv.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colRQRO_RQST_RQID,
            this.colRQRO_RWNO,
            this.colSERV_FILE_NO,
            this.colSPRB_RWNO_DNRM,
         ...
         this.Mesg_Gv.GridControl = this.gridControl1;
         this.Mesg_Gv.GroupCount = 1;
         this.Mesg_Gv.Name = "Mesg_Gv";
         this.Mesg_Gv.OptionsBehavior.AutoExpandAllGroups = true;
         this.Mesg_Gv.OptionsBehavior.Editable = false;
         this.Mesg_Gv.OptionsBehavior.ReadOnly = true;
         this.Mesg_Gv.OptionsFind.AlwaysVisible = true;
         ...
         this.Mesg_Gv.CustomUnboundColumnData += new DevExpress.XtraGrid.Views.Base.CustomColumnDataEventHandler(this.Logc_Gv_CustomUnboundColumnData);
         this.Mesg_Gv.DoubleClick += new System.EventHandler(this.Mesg_Gv_DoubleClick);
         // 
         // colRQRO_RQST_RQID
         // 
         ...
         // colSPRB_RWNO_DNRM
         // 
         this.colSPRB_RWNO_DNRM.FieldName = "SPRB_RWNO_DNRM";
         this.colSPRB_RWNO_DNRM.Name = "colSPRB_RWNO_DNRM";
         // 
         ...
         this.colTime_Period.VisibleIndex = 1;
         // 
         // colGrop_Time_Period
         // 
         ...
         this.TodayRqst_Cb.Location = new System.Drawing.Point(434, 72);
         this.TodayRqst_Cb.Name = "TodayRqst_Cb";
         this.TodayRqst_Cb.Size = new System.Drawing.Size(109, 26);
         this.TodayRqst_Cb.TabIndex = 0;
         this.TodayRqst_Cb.Tag = "005";
         this.TodayRqst_Cb.Text = "پیامک های امروز";
         ...
         this.YesterdayRqst_Cb.Location = new System.Drawing.Point(264, 40);
         this.YesterdayRqst_Cb.Name = "YesterdayRqst_Cb";
         this.YesterdayRqst_Cb.Size = new System.Drawing.Size(110, 26);
         this.YesterdayRqst_Cb.TabIndex = 0;
         this.YesterdayRqst_Cb.Tag = "004";
         this.YesterdayRqst_Cb.Text = "پیامک های دیروز";
         ...
         this.AllRqst_Cb.Location = new System.Drawing.Point(447, 8);
         this.AllRqst_Cb.Name = "AllRqst_Cb";
         this.AllRqst_Cb.Size = new System.Drawing.Size(96, 26);
         this.AllRqst_Cb.TabIndex = 0;
         this.AllRqst_Cb.TabStop = true;
         this.AllRqst_Cb.Tag = "001";
         this.AllRqst_Cb.Text = "کلیه پیامک ها";
         ...
         this.MonthRqst_Cb.Location = new System.Drawing.Point(233, 8);
         this.MonthRqst_Cb.Name = "MonthRqst_Cb";
         this.MonthRqst_Cb.Size = new System.Drawing.Size(141, 26);
         this.MonthRqst_Cb.TabIndex = 0;
         this.MonthRqst_Cb.Tag = "002";
         this.MonthRqst_Cb.Text = "پیامک های یکماه پیش";
         ...
         this.WeekRqst_Cb.Location = new System.Drawing.Point(404, 40);
         this.WeekRqst_Cb.Name = "WeekRqst_Cb";
         this.WeekRqst_Cb.Size = new System.Drawing.Size(139, 26);
         this.WeekRqst_Cb.TabIndex = 0;
         this.WeekRqst_Cb.Tag = "003";
         this.WeekRqst_Cb.Text = "پیامک های هفته پیش";
         ...
         // Comment_Txt
         // 
         this.Comment_Txt.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.MesgBs, "MESG_CMNT", true));
      ...
      private DevExpress.XtraGrid.Views.Grid.GridView Mesg_Gv;
      ...
      private DevExpress.XtraGrid.Columns.GridColumn colSPRB_RWNO_DNRM;
      ...
      private DevExpress.XtraGrid.Columns.GridColumn colMSID;
      private DevExpress.XtraGrid.Columns.GridColumn colMESG_DATE;
      private DevExpress.XtraGrid.Columns.GridColumn colMESG_CMNT;
      private DevExpress.XtraGrid.Columns.GridColumn colCELL_PHON;
      private DevExpress.XtraGrid.Columns.GridColumn colMESG_TYPE;
      private DevExpress.XtraGrid.Columns.GridColumn colMESG_STAT;
