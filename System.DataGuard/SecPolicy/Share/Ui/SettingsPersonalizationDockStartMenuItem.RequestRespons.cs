...
{
   partial class SettingsPersonalizationDockStartMenuItem : ISendRequest
   {
      public IRouter _DefaultGateway { get; set; }
      private Data.iProjectDataContext iProject;
      private string ConnectionString;
      private string CurrentUser;
      private Data.Package_Instance_User_Gateway Piug;
      ...
      {
         Piug = job.Input as Data.Package_Instance_User_Gateway;
         Execute_Query();
         job.Status = StatusType.Successful;
      }
   }
