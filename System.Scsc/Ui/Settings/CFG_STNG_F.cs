   ...
   public partial class CFG_STNG_F : UserControl
   {
      ...
      private void Execute_Query()
      {
         try
         {
            ...
            else if (tc_Settings.SelectedTab == tp_backuprestore)
            {
               ...
               iScsc.STNG_SAVE_P(
                  new XElement("Request",
                     new XElement("Settings",
                        ...
                        new XAttribute("dfltstat", Stng.DFLT_STAT),
                        new XAttribute("backup", Ckb_BACK_UP.Status),
                        new XAttribute("backupappexit", Ckb_BACK_UP_APP_EXIT.Status),
                        new XAttribute("backupintred", Ckb_BACK_UP_IN_TRED.Status),
                        new XAttribute("backupoptnpath", Ckb_BACK_UP_OPTN_PATH.Status),
                        new XAttribute("backupoptnpathadrs", Txt_BACK_UP_OPTN_PATH_ADRS.Text),
                        new XAttribute("backuprootpath", Txt_BACK_UP_ROOT_PATH.Text),
                        new XAttribute("dresstat", Stng.DRES_STAT),
                        new XAttribute("dresauto", Stng.DRES_AUTO),
                        new XAttribute("moreattnsesn", Stng.MORE_ATTN_SESN),
                        new XAttribute("notfstat", Stng.NOTF_STAT),
                        new XAttribute("notfexpday", Stng.NOTF_EXP_DAY),
                        new XAttribute("attnsysttype", Stng.ATTN_SYST_TYPE),
                        new XAttribute("commportname", Stng.COMM_PORT_NAME),
                        new XAttribute("bandrate", Stng.BAND_RATE),
                        new XAttribute("barcodedatatype", Stng.BAR_CODE_DATA_TYPE),
                        new XAttribute("ipaddr", Stng.IP_ADDR),
                        new XAttribute("portnumb", Stng.PORT_NUMB),
                        new XAttribute("attncompconct", Stng.ATTN_COMP_CONCT),

                        new XAttribute("ipadr2", Stng.IP_ADR2),
                        new XAttribute("portnum2", Stng.PORT_NUM2),
                        new XAttribute("attncompcnc2", Stng.ATTN_COMP_CNC2),
                        
                        new XAttribute("attnnotfstat", Stng.ATTN_NOTF_STAT),
                        new XAttribute("attnnotfclostype", Stng.ATTN_NOTF_CLOS_TYPE),
                        new XAttribute("attnnotfclosintr", Stng.ATTN_NOTF_CLOS_INTR),
                        new XAttribute("debtclngstat", Stng.DEBT_CLNG_STAT),
                        new XAttribute("mostdebtclngamnt", Stng.MOST_DEBT_CLNG_AMNT), 
                        new XAttribute("exprdebtday", Stng.EXPR_DEBT_DAY),
                        new XAttribute("tryvaldsbmt", Stng.TRY_VALD_SBMT)
                     )
                  )
               );
            else if(tc_Settings.SelectedTab == tp_004)
               iScsc.STNG_SAVE_P(
                  new XElement("Request",
                     new XElement("Settings",
                        ...
                        new XAttribute("dfltstat", Stng.DFLT_STAT),
                        new XAttribute("backup", Stng.BACK_UP),
                        new XAttribute("backupappexit", Stng.BACK_UP_APP_EXIT),
                        new XAttribute("backupintred", Stng.BACK_UP_IN_TRED),
                        new XAttribute("backupoptnpath", Stng.BACK_UP_OPTN_PATH),
                        new XAttribute("backupoptnpathadrs", Stng.BACK_UP_OPTN_PATH_ADRS),
                        new XAttribute("backuprootpath", Stng.BACK_UP_ROOT_PATH),
                        new XAttribute("dresstat", DresserStat_Lookup.EditValue),
                        new XAttribute("dresauto", DresserAuto_Lookup.EditValue),
                        new XAttribute("moreattnsesn", Stng.MORE_ATTN_SESN),
                        new XAttribute("notfstat", Stng.NOTF_STAT),
                        new XAttribute("notfexpday", Stng.NOTF_EXP_DAY),
                        new XAttribute("attnsysttype", Stng.ATTN_SYST_TYPE),
