namespace System.Scsc.Ui.BaseDefinition
{
   partial class BAS_GRUC_F
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.GrantUserToClub_Butn.Dock = System.Windows.Forms.DockStyle.Bottom;
         this.GrantUserToClub_Butn.ImageLocation = DevExpress.XtraEditors.ImageLocation.MiddleRight;
         this.GrantUserToClub_Butn.Location = new System.Drawing.Point(0, 361);
    ...
    "ین اطلاعات دسترسی داشته باشند";
         ...
         this.splitContainerControl1.Panel2.Controls.Add(this.GrantUserToClub_Butn);
         this.splitContainerControl1.Panel2.Text = "Panel2";
         this.splitContainerControl1.Size = new System.Drawing.Size(542, 397);
         ...
         // gridControl1
         // 
         this.gridControl1.DataSource = this.UserClubBs;
         ...
         this.repositoryItemLookUpEdit1.DataSource = this.UserBs;
         this.repositoryItemLookUpEdit1.DisplayMember = "USER_NAME";
         this.repositoryItemLookUpEdit1.Name = "repositoryItemLookUpEdit1";
         this.repositoryItemLookUpEdit1.ValueMember = "USER_DB";
         // 
         // colMAST_SYS_USER
         // 
         ...
         this.RevokeUserFromClub_Butn.Appearance.Options.UseForeColor = true;
         this.RevokeUserFromClub_Butn.Dock = System.Windows.Forms.DockStyle.Bottom;
         this.RevokeUserFromClub_Butn.ImageLocation = DevExpress.XtraEditors.ImageLocation.MiddleRight;
         this.RevokeUserFromClub_Butn.Location = new System.Drawing.Point(0, 361);
         this.RevokeUserFromClub_Butn.LookAndFeel.Style = DevExpress.LookAndFeel.LookAndFeelStyle.UltraFlat;
         this.RevokeUserFromClub_Butn.LookAndFeel.UseDefaultLookAndFeel = false;
         ...
         // cashGridControl
         // 
         this.cashGridControl.DataSource = this.UserBs;
