namespace System.CRM.Ui.BaseDefination
{
   partial class MSTT_DFIN_F
   {
      ...
      private void InitializeComponent()
      {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MSTT_DFIN_F));
         ...
         this.Mstt_Gv.Appearance.HeaderPanel.Options.UseTextOptions = true;
         this.Mstt_Gv.Appearance.HeaderPanel.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
         this.Mstt_Gv.Appearance.Row.Font = new System.Drawing.Font("Tahoma", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
         this.Mstt_Gv.Appearance.Row.Options.UseFont = true;
         this.Mstt_Gv.Appearance.Row.Options.UseTextOptions = true;
         this.Mstt_Gv.Appearance.Row.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
         this.Mstt_Gv.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colCODE,
            this.colSUB_SYS,
            this.colMSTT_DESC,
            this.colCRET_BY,
         ...
         // MsttBn
         // 
         this.MsttBn.AddNewItem = null;
         this.MsttBn.AutoSize = false;
         this.MsttBn.BindingSource = this.MsttBs;
         this.MsttBn.CountItem = this.bindingNavigatorCountItem;
         this.MsttBn.DeleteItem = null;
         this.MsttBn.GripStyle = System.Windows.Forms.ToolStripGripStyle.Hidden;
         this.MsttBn.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
         ...
         this.MsttBn.Location = new System.Drawing.Point(0, 0);
         this.MsttBn.MoveFirstItem = this.bindingNavigatorMoveFirstItem;
         this.MsttBn.MoveLastItem = this.bindingNavigatorMoveLastItem;
         this.MsttBn.MoveNextItem = this.bindingNavigatorMoveNextItem;
         this.MsttBn.MovePreviousItem = this.bindingNavigatorMovePreviousItem;
         this.MsttBn.Name = "MsttBn";
         this.MsttBn.PositionItem = this.bindingNavigatorPositionItem;
         this.MsttBn.RenderMode = System.Windows.Forms.ToolStripRenderMode.System;
         this.MsttBn.Size = new System.Drawing.Size(384, 25);
         this.MsttBn.TabIndex = 0;
         this.MsttBn.Text = "bindingNavigator1";
         // 
         ...
         this.AddApbs_Butn.Click += new System.EventHandler(this.AddMstt_Butn_Click);
         // 
         // Tsb_DelApbs
         // 
         ...
         this.Tsb_DelApbs.Click += new System.EventHandler(this.Tsb_DelMstt_Click);
         // 
         ...
         this.Sstt_Gv.Appearance.HeaderPanel.Options.UseTextOptions = true;
         this.Sstt_Gv.Appearance.HeaderPanel.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
         this.Sstt_Gv.Appearance.Row.Font = new System.Drawing.Font("Tahoma", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
         this.Sstt_Gv.Appearance.Row.Options.UseFont = true;
         this.Sstt_Gv.Appearance.Row.Options.UseTextOptions = true;
         this.Sstt_Gv.Appearance.Row.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
         this.Sstt_Gv.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.colMSTT_CODE,
         ...
         // SsttBn
         // 
         this.SsttBn.AddNewItem = null;
         this.SsttBn.AutoSize = false;
         this.SsttBn.BindingSource = this.SsttBs;
         this.SsttBn.CountItem = this.toolStripLabel1;
         this.SsttBn.DeleteItem = null;
         this.SsttBn.GripStyle = System.Windows.Forms.ToolStripGripStyle.Hidden;
         this.SsttBn.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
         ...
         this.SsttBn.Location = new System.Drawing.Point(0, 0);
         this.SsttBn.MoveFirstItem = this.toolStripButton2;
         this.SsttBn.MoveLastItem = this.toolStripButton5;
         this.SsttBn.MoveNextItem = this.toolStripButton4;
         this.SsttBn.MovePreviousItem = this.toolStripButton3;
         this.SsttBn.Name = "SsttBn";
         this.SsttBn.PositionItem = this.toolStripTextBox1;
         this.SsttBn.RenderMode = System.Windows.Forms.ToolStripRenderMode.System;
         this.SsttBn.Size = new System.Drawing.Size(384, 25);
         this.SsttBn.TabIndex = 2;
         this.SsttBn.Text = "bindingNavigator1";
         // 
         // toolStripLabel1
         // 
         ...
         this.AddSapb_Butn.Click += new System.EventHandler(this.AddSstt_Butn_Click);
         // 
         // Tsb_DelSapb
         // 
         ...
         this.Tsb_DelSapb.Click += new System.EventHandler(this.Tsb_DelSstt_Click);
         // 
         // toolStripButton7
         // 
         ...
         // 
         this.base_Tariff_DetailsGridControl.DataSource = this.SsttBs;
         ...
         this.panelControl5.Size = new System.Drawing.Size(390, 49);
         ...
         this.labelControl15.Location = new System.Drawing.Point(203, 2);
         this.labelControl15.Name = "labelControl15";
         this.labelControl15.Size = new System.Drawing.Size(185, 45);
      ...
      private DevExpress.XtraGrid.Views.Grid.GridView Mstt_Gv;
      private Windows.Forms.BindingNavigator MsttBn;
      ...
      private Windows.Forms.BindingNavigator SsttBn;
      ...
      private DevExpress.XtraGrid.Views.Grid.GridView Sstt_Gv;
