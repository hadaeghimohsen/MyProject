            ...
            switch (srchtype)
            {
               ...
               case "002":
                  MesgBs.DataSource =
                     ...
                     .Where(l =>
                        l.SERV_FILE_NO == fileno &&
                        l.MESG_DATE.Value.Date >= DateTime.Now.AddMonths(-1)
                     );                     
                  break;
               case "003":
                  MesgBs.DataSource =
                     ...
                     .Where(l =>
                        l.SERV_FILE_NO == fileno &&
                        l.MESG_DATE.Value.Date >= DateTime.Now.AddDays(-7)
                     );                     
                  break;
               case "004":
                  MesgBs.DataSource =
                     ...
                     .Where(l =>
                        l.SERV_FILE_NO == fileno &&
                        l.MESG_DATE.Value.Date == DateTime.Now.AddDays(-1).Date
                     );                     
                  break;
               case "005":
                  MesgBs.DataSource =
                     ...
                     .Where(l =>
                        l.SERV_FILE_NO == fileno &&
                        l.MESG_DATE.Value.Date == DateTime.Now.Date
                     );                     
                  break;
               case "006":
                  ...
                  MesgBs.DataSource =
                     ...
                     .Where(l =>
                        l.SERV_FILE_NO == fileno &&
                        l.MESG_DATE.Value.Date == RqstToDate_Date.Value.Value.Date
                     );
                  break;
               default:
                  break;
