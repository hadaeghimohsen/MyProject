namespace System.RoboTech.Ui.DevelopmentApplication
{
   partial class ORML_DVLP_F
   {
      ...
      private void InitializeComponent()
      {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ORML_DVLP_F));
         ...
         this.colORDT_ORDR_CODE = new DevExpress.XtraGrid.Columns.GridColumn();
         ...
         ((System.ComponentModel.ISupportInitialize)(this.Sndt_Lov)).BeginInit();
         ...
         this.labelControl15.Text = "لیست پیام های ارسال شده";
         // 
         // panel3
         // 
         ...
         // colORDT_ORDR_CODE
         // 
         this.colORDT_ORDR_CODE.FieldName = "ORDT_ORDR_CODE";
         this.colORDT_ORDR_CODE.Name = "colORDT_ORDR_CODE";
         // 
         // colORDT_RWNO
         // 
         this.colORDT_RWNO.FieldName = "ORDT_RWNO";
         this.colORDT_RWNO.Name = "colORDT_RWNO";
         // 
         // colRWNO
         // 
         ...
         // colRPLY_DATE
         // 
         this.colRPLY_DATE.Caption = "تاریخ پاسخ پیام";
         ...
         this.colSEND_STAT.ColumnEdit = this.Sndt_Lov;
         ...
         // colOrder_Detail
         // 
         this.colOrder_Detail.FieldName = "Order_Detail";
         this.colOrder_Detail.Name = "colOrder_Detail";
         // 
         // colService_Robot
         // 
         ...
         ((System.ComponentModel.ISupportInitialize)(this.Sndt_Lov)).EndInit();
      ...
      private DevExpress.XtraGrid.Columns.GridColumn colORDT_ORDR_CODE;
      private DevExpress.XtraGrid.Columns.GridColumn colORDT_RWNO;
      ...
      private DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit Sndt_Lov;
      ...
      private DevExpress.XtraGrid.Columns.GridColumn colOrder_Detail;
