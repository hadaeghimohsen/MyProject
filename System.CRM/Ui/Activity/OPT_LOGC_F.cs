      ...
      private long rqstrqid, projrqstrqid;
       ...
       private async void Execute_Query()
       {
          ...
          var result = await Task.Run(() =>
          {
             ...
             {
                return ctx.Services.Where(s => s.FILE_NO == _fileno && s.CONF_STAT == "002" && Convert.ToInt32(s.ONOF_TAG_DNRM) >= 101).ToList();
             }
          });
         ...
         try
         {
            ...
            iCRM.OPR_LSAV_P(
               new XElement("LogCall",
                  ...
                  new XAttribute("colr", logc.Request_Row != null ? logc.Request_Row.Request.COLR : "#ADFF2F"),
