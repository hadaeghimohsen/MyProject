...
{
   partial class HST_URQS_F : ISendRequest
   {
      ...
      {
         SwitchButtonsTabPage(iRequest_Butn);
         job.Status = StatusType.Successful;
      }
      ...
      private void SetFilterOnQuery(Job job)
      {
         ...
         if(xinput != null)
         {
            ...
            {
               case "tag":
                  TextSearch_Txt.Properties.Buttons[2].ToolTip = xinput.Attribute("cont").Value == "0" ? "فیلتری برای برچسب در نظر گرفته نشده" : "برچسب بااعمال فیلتر انتخابی اجرا میشود";
                  TextSearch_Txt.Properties.Buttons[2].Tag = xinput;
                  break;
               case "region":
                  TextSearch_Txt.Properties.Buttons[3].ToolTip = xinput.Attribute("cont").Value == "0" ? "فیلتری برای برچسب در نظر گرفته نشده" : "برچسب بااعمال فیلتر انتخابی اجرا میشود";
                  TextSearch_Txt.Properties.Buttons[3].Tag = xinput;
                  break;
               default:
                  break;
            }
