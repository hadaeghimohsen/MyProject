namespace System.CRM.Ui.HistoryAction
{
   partial class HST_NOTE_F
   {
      ...
      private void InitializeComponent()
      {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(HST_NOTE_F));
         ...
         this.labelControl1.Text = "تاریخچه یادداشت";
         // 
         // gridControl1
         // 
         ...
         this.Note_Gv.Appearance.GroupRow.Options.UseTextOptions = true;
         this.Note_Gv.Appearance.GroupRow.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
         this.Note_Gv.Appearance.HeaderPanel.Font = new System.Drawing.Font("IRANSans", 9F);
         ...
         this.Note_Gv.Appearance.Row.Font = new System.Drawing.Font("IRANSans", 9F);
         ...
         this.Note_Gv.GroupCount = 1;
         this.Note_Gv.Name = "Note_Gv";
         this.Note_Gv.OptionsBehavior.AutoExpandAllGroups = true;
         this.Note_Gv.OptionsBehavior.Editable = false;
         this.Note_Gv.OptionsBehavior.ReadOnly = true;
         this.Note_Gv.OptionsFind.AlwaysVisible = true;
         ...
         this.Note_Gv.CustomUnboundColumnData += new DevExpress.XtraGrid.Views.Base.CustomColumnDataEventHandler(this.Logc_Gv_CustomUnboundColumnData);
         this.Note_Gv.DoubleClick += new System.EventHandler(this.Note_Gv_DoubleClick);
         // 
         // colRQRO_RQST_RQID
         // 
         ...
         this.TodayRqst_Cb.Location = new System.Drawing.Point(422, 72);
         this.TodayRqst_Cb.Name = "TodayRqst_Cb";
         this.TodayRqst_Cb.Size = new System.Drawing.Size(121, 26);
         this.TodayRqst_Cb.TabIndex = 0;
         this.TodayRqst_Cb.Tag = "005";
         this.TodayRqst_Cb.Text = "یادداشت های امروز";
         ...
         this.YesterdayRqst_Cb.Location = new System.Drawing.Point(252, 40);
         this.YesterdayRqst_Cb.Name = "YesterdayRqst_Cb";
         this.YesterdayRqst_Cb.Size = new System.Drawing.Size(122, 26);
         this.YesterdayRqst_Cb.TabIndex = 0;
         this.YesterdayRqst_Cb.Tag = "004";
         this.YesterdayRqst_Cb.Text = "یادداشت های دیروز";
         ...
         this.AllRqst_Cb.Location = new System.Drawing.Point(435, 8);
         this.AllRqst_Cb.Name = "AllRqst_Cb";
         this.AllRqst_Cb.Size = new System.Drawing.Size(108, 26);
         this.AllRqst_Cb.TabIndex = 0;
         this.AllRqst_Cb.TabStop = true;
         this.AllRqst_Cb.Tag = "001";
         this.AllRqst_Cb.Text = "کلیه یادداشت ها";
         ...
         this.MonthRqst_Cb.Location = new System.Drawing.Point(221, 8);
         this.MonthRqst_Cb.Name = "MonthRqst_Cb";
         this.MonthRqst_Cb.Size = new System.Drawing.Size(153, 26);
         this.MonthRqst_Cb.TabIndex = 0;
         this.MonthRqst_Cb.Tag = "002";
         this.MonthRqst_Cb.Text = "یادداشت های یکماه پیش";
         ...
         this.WeekRqst_Cb.Location = new System.Drawing.Point(392, 40);
         this.WeekRqst_Cb.Name = "WeekRqst_Cb";
         this.WeekRqst_Cb.Size = new System.Drawing.Size(151, 26);
         this.WeekRqst_Cb.TabIndex = 0;
         this.WeekRqst_Cb.Tag = "003";
         this.WeekRqst_Cb.Text = "یادداشت های هفته پیش";
         ...
         // Comment_Txt
         // 
         this.Comment_Txt.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.NoteBs, "NOTE_CMNT", true));
