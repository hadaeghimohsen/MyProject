...
namespace System.MaxUi
{
   ...
   ToolboxBitmap(typeof(resfinder), "Resources.IMAGE_1737.bmp")]
   public class XRoundButton : System.Windows.Forms.Button
   {
    ...
    Description("Specifies the depth of the button's bevel.")]
      ...
      private XVerticalString vs;                                      // Create vertical text for this buttons
