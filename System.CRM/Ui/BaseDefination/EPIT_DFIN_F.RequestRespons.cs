...
namespace System.CRM.Ui.BaseDefination
{
   partial class EPIT_DFIN_F : ISendRequest
   {
               ...
               new List<Job>
               {
                  new Job(SendType.External, "Commons",
                     new List<Job>
                     {
                        ...
                        {
                           Input = new List<string> {"<Privilege>12</Privilege><Sub_Sys>11</Sub_Sys>", "DataGuard"},
      ...
      private void LoadData(Job job)
      {
         ...
         {
            firstloaded = true;
            RqtpBs.DataSource = iCRM.Request_Types;
            RqttBs.DataSource = iCRM.Requester_Types;
            DysnoBs.DataSource = iCRM.D_YSNOs;
            DittpBs.DataSource = iCRM.D_ITTPs;
         }
