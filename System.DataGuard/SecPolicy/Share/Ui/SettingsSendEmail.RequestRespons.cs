...
{
   partial class SettingsSendEmail : ISendRequest
   {
      public IRouter _DefaultGateway { get; set; }
      private Data.iProjectDataContext iProject;
      private string ConnectionString;
      private string CurrentUser;
      private string emailtype = "normal";
      ...
      {
         ToEmail_Lst.Items.Clear();
         ToEmail_Txt.Text = "";
         Subject_Txt.Text = "";
         Comment_Txt.Text = "";
         FileAttach_Lst.Items.Clear();
         FileAttach_Txt.Text = "";
         job.Status = StatusType.Successful;
      }
      ...
      private void ActionCallWindow(Job job)
      {
         ...
         emailtype = xinput.Attribute("type").Value;
