...
namespace System.MaxUi
{
   ...
   //[Designer(typeof(NewToolPickBntDesing))]
   [DefaultEvent("PickCheckedChange")]
   public partial class NewToolPickBnt : UserControl
   {
      public NewToolPickBnt()
      {
         InitializeComponent();
      }
      ...
      public NewToolPickBnt Next
      {
         get { return next; }
         set { next = value; }
      }
      public NewToolPickBnt First
      {
         get { return first; }
         set { first = value; }
      }
         ...
         set
         {
            ...
            if (disabled == false)
            {
               ...
               else
               {
                  ...
                  top.BackColor = Color.Transparent; //Color.FromArgb(225, 225, 225);
                  left.BackColor = Color.Transparent; //Color.FromArgb(225, 225, 225);
                  down.BackColor = Color.Transparent; //Color.FromArgb(130, 130, 130);
                  right.BackColor = Color.Transparent; //Color.FromArgb(130, 130, 130);
               }
      ...
      private void PickUp(NewToolPickBnt p)
      {
         if (ImageList != null)
         {
            name.ImageList = ImageList;
            name.ImageIndex = imageIndexPickUp;
            name.ImageAlign = ImageAlign;
         }

         p.name.Text = p.PickUpText;
         p.name.Font = p.PickUpFont;
         //name.TextAlign = TextAligns;
         p.name.ForeColor = p.PickUpTextColor;
         p.name.BackColor = Color.Transparent;//Color.FromArgb(197, 197, 197);

         p.top.BackColor = Color.Transparent; //Color.FromArgb(225, 225, 225);
         p.left.BackColor = Color.Transparent; //Color.FromArgb(225, 225, 225);
         p.down.BackColor = Color.Transparent; //Color.FromArgb(130, 130, 130);
         p.right.BackColor = Color.Transparent; //Color.FromArgb(130, 130, 130);
      }

      private void PickDown(NewToolPickBnt p)
      {
         if (ImageList != null)
         {
            name.ImageList = ImageList;
      ...
      private void name_MouseMove(object sender, MouseEventArgs e)
      {
         if (!disabled)
         {
            name_MouseEnter(null, null);
         }
      }
      public void name_MouseLeave(object sender, EventArgs e)
      {
         if (Disabled == false)
         {
            if (PickChecked == false)
               top.BackColor = left.BackColor = down.BackColor = right.BackColor = Color.Transparent;//Color.FromArgb(197, 197, 197);
         }
      }

      private void NewToolPickBnt_Load(object sender, EventArgs e)
      {
         if (PickChecked)
         {
            PickDown(this);
      ...
      private void NewToolPickBnt_SizeChanged(object sender, EventArgs e)
      {
   ...
   public class NewToolPickBntActionList : DesignerActionList
   {
      private NewToolPickBnt linkControl;
      public NewToolPickBntActionList(NewToolPickBnt ctrl)
         : base(ctrl)
      {
         linkControl = ctrl;
      }
   ...
   public class NewToolPickBntDesing : ParentControlDesigner
   {
      ...
      public override DesignerActionListCollection ActionLists
      {
         get
         {
            if (actionLists == null)
            {
               ...
               actionLists.Add(new NewToolPickBntActionList((NewToolPickBnt)Control));
            }
            return actionLists;
         }
      }
