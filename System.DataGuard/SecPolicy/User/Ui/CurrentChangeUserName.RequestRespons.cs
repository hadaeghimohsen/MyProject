...
{
   partial class CurrentChangeUserName : ISendRequest
   {
      ...
      {
         Enabled = true;
         Txt_UserName.Text = LB_CurrentUserName.Text = job.Input.ToString();
         job.Status = StatusType.Successful;
      }
      ...
      private new void Paint(Job job)
      {
         Job _Paint = new Job(SendType.External, "Desktop",
            new List<Job>
            {
               ...
               new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */) {  Input = new List<object> { "DataGuard:SecurityPolicy:User:CurrentChangeUserName", this }  },
