...
{
   partial class MNG_RCAN_F : ISendRequest
   {
                  ...
                  new Job(SendType.External, "Commons",
                     new List<Job>
                     {
                        ...
                        new Job(SendType.Self, 07 /* Execute DoWork4AccessPrivilege */)
                        {
                           ...
                           {
                              string.Format("<Privilege>{0}</Privilege><Sub_Sys>5</Sub_Sys>", (job.Input as XElement).Attribute("type").Value == "In" ? "148" : "147"), 
                              "DataGuard"
                           },
                           AfterChangedOutput = new Action<object>((output) => {
                              if ((bool)output)
                                 return;
                              MessageBox.Show(string.Format("خطا - عدم دسترسی به ردیف {0} سطوح امینتی", (job.Input as XElement).Attribute("type").Value == "In" ? "148" : "147"));
                           })
                        },
                        #endregion
                     }),
      ...
      {
         //Execute_Query();
         DRcanBs1.DataSource = iScsc.D_RCANs;
