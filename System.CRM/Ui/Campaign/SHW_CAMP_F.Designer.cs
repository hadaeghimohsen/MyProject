namespace System.CRM.Ui.Campaign
{
   partial class SHW_CAMP_F
   {
      ...
      private void InitializeComponent()
      {
         ...
         // Acnt_Gc
         // 
         this.Acnt_Gc.DataSource = this.CampBs;
         ...
         // colTEMP
         // 
         this.colTEMP.Caption = "آیا قالب می باشد؟";
         this.colTEMP.ColumnEdit = this.repositoryItemLookUpEdit1;
         ...
         // colNAME
         // 
         this.colNAME.Caption = "عنوان تبلیغات";
