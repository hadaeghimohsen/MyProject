...
{
   partial class ATN_SAVE_F : ISendRequest
   {
      ...
      private void ProcessCmdKey(Job job)
      {
         ...
         {
            job.Next =
               new Job(SendType.SelfToUserInterface, "ATN_SAVE_F", 04 /* Execute UnPaint */);
         }
      ...
      private void Set(Job job)
      {
         ...
         Pdt_AttnDate.DateTime = DateTime.Now;
      ...
      private new void Paint(Job job)
      {
         Job _Paint = new Job(SendType.External, "Desktop",
            new List<Job>
            {
               ...
               new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */) {  Input = new List<object> { "Scsc:ATN_SAVE_F", this }  },
