...
{
   partial class SettingsChangeNetwork : ISendRequest
   {
      public IRouter _DefaultGateway { get; set; }
      private Data.iProjectDataContext iProject;
      private string ConnectionString;
      private string CurrentUser;
      private XElement XUserHostApp;
      private string User;
      ...
      {
         XUserHostApp = job.Input as XElement;
         User = XUserHostApp.Attribute("user").Value;
         HostName = XUserHostApp.Attribute("hostname").Value;
         SubSys = Convert.ToInt32(XUserHostApp.Attribute("subsys").Value);
