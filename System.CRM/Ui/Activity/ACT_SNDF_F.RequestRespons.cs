...
{
   partial class ACT_SNDF_F : ISendRequest
   {
      ...
      private new void Paint(Job job)
      {
         ...
         groupBox2.Width = (panel1.Width - 12) - groupBox2.Left;
         groupBox6.Width = (panel1.Width - 14) - groupBox6.Left;
      ...
      private void LoadData(Job job)
      {
         ...
         DsdtpBs1.DataSource = iCRM.D_SDTPs;
         JbpsBs1.DataSource = iCRM.Job_Personnels.Where(jp => jp.STAT == "002");
         ServBs1.DataSource = iCRM.Services.Where(s => s.CONF_STAT == "002");
      ...
      private void Actn_CalF_P(Job job)
      {
         ...
         {
            case "find":
               long rqid = Convert.ToInt64(xinput.Attribute("rqid").Value);
               RqstBs1.Position = RqstBs1.IndexOf(RqstBs1.List.OfType<Data.Request>().ToList().Find(r => r.RQID == rqid));
               break;
            default:
               break;
         }
