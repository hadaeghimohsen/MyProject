namespace System.Scsc.Ui.Common
{
   partial class LSI_FLDF_F
   {
    ...
    "باشد";
         ...
         styleFormatCondition14.Expression = "Today() >= [STRT_DATE] And Today()  <= [END_DATE] And [VALD_TYPE] == \'002\'";
         ...
         // gridColumn82
         // 
         this.gridColumn82.Caption = "کاربر ثبت کننده";
