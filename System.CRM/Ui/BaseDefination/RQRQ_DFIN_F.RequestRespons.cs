...
namespace System.CRM.Ui.BaseDefination
{
   partial class RQRQ_DFIN_F : ISendRequest
   {
               ...
               new List<Job>
               {
                  new Job(SendType.External, "Commons",
                     new List<Job>
                     {
                        ...
                        {
                           Input = new List<string> {"<Privilege>31</Privilege><Sub_Sys>11</Sub_Sys>", "DataGuard"},
      ...
      private void LoadData(Job job)
      {
         ...
         if(!firstloaded)
         {
            DpermBs.DataSource = iCRM.D_PERMs;
            EpitBs.DataSource = iCRM.Expense_Items.Where(epit => epit.TYPE == "001");
            DexptBs.DataSource = iCRM.D_EXPTs;
            DactvBs.DataSource = iCRM.D_ACTVs;
            DysnoBs.DataSource = iCRM.D_YSNOs;
            TrfdBs.DataSource = iCRM.Base_Tariff_Details;
            DcspBs.DataSource = iCRM.Document_Specs;
            DdcndBs.DataSource = iCRM.D_DCNDs;
            DdctpBs.DataSource = iCRM.D_DCTPs;
         }
         Execute_Query();
         job.Status = StatusType.Successful;
      }
