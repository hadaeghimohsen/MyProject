...
{
   partial class PropertySingleRoleMenu : ISendRequest
   {
             ...
             new List<Job>
              {
                  ...
                  new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */){Input = new List<object>{"DataGuard:SecurityPolicy:Role:PropertySingleRoleMenu", this}},
