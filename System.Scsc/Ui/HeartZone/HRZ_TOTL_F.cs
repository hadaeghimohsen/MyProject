...
{
   public partial class HRZ_TOTL_F : UserControl
   {
      public HRZ_TOTL_F()
      {
         InitializeComponent();
      ...
      private void RqroBs1_CurrentChanged(object sender, EventArgs e)
      {
         ...
         OldRecdBs1.DataSource = iScsc.Heart_Zones.Where(c => c.FIGH_FILE_NO == Rqro.FIGH_FILE_NO && c.RECT_CODE == "004" && c.Fighter.HERT_RWNO_DNRM == c.RWNO);
      }
                  ...
                  new XElement("Process",
                     new XElement("Request",
                        ...
                        new XElement("Request_Row",
                           ...
                           new XElement("Heart_Zone",
                              new XAttribute("resthertrate", REST_HERT_RATE_TextEdit.Text)
                           )
                        )
                     )
                  )
            ...
            _DefaultGateway.Gateway(
               new Job(SendType.External, "Localhost",
                  new List<Job>
                  {
                     ...
                     new Job(SendType.SelfToUserInterface, "REGL_DCMT_F", 10 /* Execute Actn_CalF_P */){Input = new XElement("Regulation", new XElement("Request_Requester", new XAttribute("rqtpcode", "004")))}
                  })
               );
         }
      }
