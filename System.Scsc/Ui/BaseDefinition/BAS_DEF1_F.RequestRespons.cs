...
{
   partial class BAS_DEF1_F : ISendRequest
   {
      ...
      {
         RqtpBs.DataSource = iScsc.Request_Types.Where(a => (a.CODE == "001" || a.CODE == "016" || a.CODE == "012"));
         RqttBs.DataSource = iScsc.Requester_Types.Where(a => (a.CODE == "001" || a.CODE == "004"));
         DIttpBs.DataSource = iScsc.D_ITTPs.Where(a => (a.VALU == "001" || a.VALU == "002"));
