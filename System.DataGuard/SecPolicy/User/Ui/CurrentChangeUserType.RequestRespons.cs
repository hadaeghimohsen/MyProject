...
{
   partial class CurrentChangeUserType : ISendRequest
   {
      ...
      private new void Paint(Job job)
      {
         Job _Paint = new Job(SendType.External, "Desktop",
            new List<Job>
            {
               ...
               new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */) {  Input = new List<object> { "DataGuard:SecurityPolicy:User:CurrentChangeUserType", this }  },
      ...
      private void LoadData(Job job)
      {
         ...
         if (userinfo.DFLT_FACT == "002")
         {
            Ts_DefaultFactory.IsOn = userinfo.DFLT_FACT == null || userinfo.DFLT_FACT == "001" ? false : true;
            Ts_DefaultFactory.Enabled = true;
         }
         else { Ts_DefaultFactory.Enabled = false; }
         Ts_SafeEnter.IsOn = userinfo.PLCY_FORC_SAFE_ENTR == null || userinfo.PLCY_FORC_SAFE_ENTR == "001" ? false : true;
         Ts_AddComputer.IsOn = userinfo.ADD_COMP_LIST == null || userinfo.ADD_COMP_LIST == "001" ? false : true;
         Txt_EmailAddress.Text = userinfo.EMAL_ADRS;
         job.Status = StatusType.Successful;
      }
