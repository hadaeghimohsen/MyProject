...
{
   partial class SHW_CAMP_F : ISendRequest
   {
      ...
      {
         var mklt = CampBs.Current as Data.Marketing_List;
         if (mklt == null) return;

         var xinput = job.Input as XElement;
         var newmklt = CampBs.Current as Data.Marketing_List;
         ...
         if (xinput != null)
         {
            switch (xinput.Attribute("moveposition").Value)
            {
               case "next":
                  CampBs.MoveNext();
                  newmklt = CampBs.Current as Data.Marketing_List;
