...
{
   partial class Duplicate : ISendRequest
   {
      ...
      private void Set(Job job)
      {
         ...
         te_source.Text = XElement.Parse(value).Element("GhFaName").Value;
         te_source.Tag = XElement.Parse(value).Element("GroupHeaderID").Value;
         te_titlefa.Text = te_titleen.Text = "";
         job.Status = StatusType.Successful;
      }
             ...
             new List<Job>
              {
                  ...
                  new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */){Input = new List<object>{"ServiceDefinition:GroupHeader:Duplicate", this}},
