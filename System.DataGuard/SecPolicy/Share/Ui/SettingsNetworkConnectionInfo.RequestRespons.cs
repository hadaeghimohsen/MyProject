...
{
   partial class SettingsNetworkConnectionInfo : ISendRequest
   {
      public IRouter _DefaultGateway { get; set; }
      private Data.iProjectDataContext iProject;
      private string ConnectionString;
      private string CurrentUser;
      private Data.Access_User_Datasource AccessUserDatasource;
      ...
      {
         DatasourceBs.DataSource = iProject.DataSources.Where(aud => aud.Sub_System.INST_STAT == "002");
         UserBs.DataSource = iProject.Users.Where(u => !u.IsLock);
      ...
      {
         AccessUserDatasource = job.Input as Data.Access_User_Datasource;
         Execute_Query();
         job.Status = StatusType.Successful;
      }
   }
