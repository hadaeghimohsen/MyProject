...
{
   partial class OPT_AEML_F : ISendRequest
   {
      ...
      {
         ApbsBs.DataSource = iCRM.App_Base_Defines.Where(a => a.ENTY_NAME == "CONTACT_INFO");
         job.Status = StatusType.Successful;
      }
      ...
      private void Actn_CalF_P(Job job)
      {
         ...
         if(xinput != null)
         {
            ...
            Lb_ServCount.Text = xinput.Element("Services").Attribute("cont").Value;
            Lb_ServCount.Tag = xinput;
            Email_Time.EditValue = DateTime.Now;
            Email_Date.Value = DateTime.Now;
            Schedular_Tg.IsOn = true;
         }
