...
namespace System.CRM.Ui.Payment
{
   public partial class PAY_MTOD_F : UserControl
   {
      ...
      private void Execute_Query()
      {
         ...
         PymtBs1.DataSource = iCRM.Payments.Where(p => p == PymtBs1.Current);
      ...
      private void AddDebtDiscount_Butn002_Click(object sender, EventArgs e)
      {
         try
         {
            ...
            var pymt = iCRM.Payments.FirstOrDefault(p => p == PymtBs1.Current);
            if (pymt.SUM_EXPN_PRIC <= 0)
            {
               MessageBox.Show("هزینه برای خریدار صفر میباشد. نیازی به محاسبه تخفیف مانده حساب نیست");
               return;
            }
      ...
      private void DelPyds_Butn_Click(object sender, EventArgs e)
      {
         try
         {
            ...
            iCRM.Payment_Discounts.DeleteOnSubmit(pyds);
      ...
      private void SaveDifferenceAmnt_Butn_Click(object sender, EventArgs e)
      {
         try
         {
            ...
            pyds.AMNT = Convert.ToInt32(Te_TotlRemnAmnt.EditValue);
            pyds.AMNT_TYPE = "004";
            pyds.PYDS_DESC = "کسر مبلغ مابه التفاوت هزینه پرداخت شده";
