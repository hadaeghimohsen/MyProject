...
{
   public partial class AOP_CBMT_F : UserControl
   {
      public AOP_CBMT_F()
      {
         InitializeComponent();
      ...
      private void Execute_Query()
      {
         ...
         AgopBs1.DataSource = iScsc.Aggregation_Operations.Where(a => a.OPRT_TYPE == "002" && (a.OPRT_STAT == "001" || a.OPRT_STAT == "002"));
            ...
            iScsc.INS_AGOP_P(
               new XElement("Process",
                  new XElement("Aggregation_Operation",
                     ...
                     new XAttribute("rqtpcode", crnt.RQTP_CODE ?? "002"),
                     ...
                     new XAttribute("oprttype", crnt.OPRT_TYPE ?? "002"),
