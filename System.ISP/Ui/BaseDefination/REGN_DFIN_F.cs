   ...
   public partial class REGN_DFIN_F : UserControl
   {
      ...
      private void Tsb_DelPrvn_Click(object sender, EventArgs e)
      {
         try
         {
            ...
            iISP.DEL_PRVN_P(prvn.CNTY_CODE, prvn.CODE);
            requery = true;
         }
         catch (Exception exc)
         {
      ...
      private void Tsb_DelRegn_Click(object sender, EventArgs e)
      {
         try
         {
            ...
            iISP.DEL_REGN_P(regn.PRVN_CNTY_CODE, regn.PRVN_CODE, regn.CODE);
            requery = true;
         }
         catch (Exception exc)
         {
      ...
      private void Tsb_DelAgnc_Click(object sender, EventArgs e)
      {
         try
         {
            ...
            var agnc = AgncBs.Current as Data.Agency;

            iISP.DEL_AGNC_P(agnc.CODE);
            requery = true;
         }
         catch (Exception exc)
         {
