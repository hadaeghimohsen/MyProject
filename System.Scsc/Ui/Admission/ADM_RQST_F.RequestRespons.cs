...
{
   partial class ADM_RQST_F : ISendRequest
   {
      ...
      private void ProcessCmdKey(Job job)
      {
         ...
         {
            job.Next =
               new Job(SendType.SelfToUserInterface, "ADM_RQST_F", 04 /* Execute UnPaint */);
         }
      ...
      private new void Paint(Job job)
      {
         Job _Paint = new Job(SendType.External, "Desktop",
            new List<Job>
            {
               ...
               new Job(SendType.SelfToUserInterface, "Wall", 15 /* Execute Push */) {  Input = new List<object> { "Scsc:ADM_RQST_F", this }  },
      ...
      private void LoadData(Job job)
      {
         ...
         diseasesTypeBindingSource.DataSource = iScsc.Diseases_Types;
         ...
         dCOCHBindingSource.DataSource = iScsc.D_DEGRs;
         dGUDGBindingSource.DataSource = iScsc.D_DEGRs;
         dEDUCBindingSource.DataSource = iScsc.D_EDUCs;
         CoachBindingSource.DataSource = iScsc.Fighters.Where(f => f.CONF_STAT == "002" && (f.FGPB_TYPE_DNRM == "002" || f.FGPB_TYPE_DNRM == "003"));
         clubMethodBindingSource.DataSource = iScsc.Club_Methods;
         dDYTPBindingSource.DataSource = iScsc.D_DYTPs;
