...
{
   partial class RQRQ_DFIN_F : ISendRequest
   {
      public IRouter _DefaultGateway { get; set; }
      private Data.iISPDataContext iISP;
      private string ConnectionString;
      private bool firstloaded = false;
      private Data.Regulation crntRegulation;
               ...
               new List<Job>
               {
                  new Job(SendType.External, "Commons",
                     new List<Job>
                     {
                        ...
                        {
                           Input = new List<string> {"<Privilege>31</Privilege><Sub_Sys>10</Sub_Sys>", "DataGuard"},
      ...
      {
         crntRegulation = job.Input as Data.Regulation;

         if(!firstloaded)
         {
            DpermBs.DataSource = iISP.D_PERMs;
            EpitBs.DataSource = iISP.Expense_Items.Where(epit => epit.TYPE == "001");
            DexptBs.DataSource = iISP.D_EXPTs;
            DactvBs.DataSource = iISP.D_ACTVs;
            DysnoBs.DataSource = iISP.D_YSNOs;
            TrfdBs.DataSource = iISP.Base_Tariff_Details;
            DcspBs.DataSource = iISP.Document_Specs;
            DdcndBs.DataSource = iISP.D_DCNDs;
            DdctpBs.DataSource = iISP.D_DCTPs;
         }
         Execute_Query();
         job.Status = StatusType.Successful;
      }
