...
{
   partial class OIC_SMSN_F : ISendRequest
   {
      ...
      private void Actn_CalF_P(Job job)
      {
         ...
         if ((job.Input as XElement).Attribute("type").Value == "setcard")
         {
            CardNum_Txt.Text = (job.Input as XElement).Attribute("value").Value;
         }
         ...
         if ((job.Input as XElement).Attribute("enrollnumber") != null)
         {
            ...
            {
               FNGR_PRNT_TextEdit.Text = (job.Input as XElement).Attribute("enrollnumber").Value;
